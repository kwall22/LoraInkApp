...
#define GxEPD2_7C_IS_GxEPD2_7C true //MINE 
...
#define IS_GxEPD2_7C(x) IS_GxEPD(GxEPD2_7C_IS_, x) //MINE
...
// THIS ONE IS MINE
// Heltec:
//GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=5*/ EPD_CS, /*DC=*/ 33, /*RST=*/ 35, /*BUSY=*/ 36)); // my suggested wiring and proto board
// Seeed:
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=5*/ 41, /*DC=*/ 6, /*RST=*/ 4, /*BUSY=*/ 3)); // my suggested wiring and proto board
